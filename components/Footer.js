    ...
    <footer style={styles.footer}>
        ...
        <div style={styles.coluna}>
          ...
          <div style={styles.contato}>
            ...
            <div style={styles.contatoItem}>
              ...
              href="https://www.google.com/maps/place/Lu+Perfumes+%26+Presentes/@-29.5495891,-49.8947045,17z"
              target="_blank"
      ...
      <div style={styles.bottomBar}>
        <div style={styles.bottomContent}>
          <p style={styles.bottomTexto}>© 2025 Lu Perfumes & Presentes — Todos os direitos reservados</p>
