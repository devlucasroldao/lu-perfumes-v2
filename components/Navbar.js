      ...
      <div style={styles.container}>
        ...
        <div style={styles.links}>
          <div style={styles.dropdown}>
            <span style={styles.link} onClick={() => { setLinhaOpen(!linhaOpen); setMarcaOpen(false); setTipoOpen(false); }}>
              Por Linha ▾
            </span>
            {linhaOpen && (
          ...
          <div style={styles.dropdown}>
            <span style={styles.link} onClick={() => { setMarcaOpen(!marcaOpen); setLinhaOpen(false); setTipoOpen(false); }}>
              Por Marca ▾
            </span>
            {marcaOpen && (
              <div style={styles.dropMenu}>
          ...
          <div style={styles.dropdown}>
            <span style={styles.link} onClick={() => { setTipoOpen(!tipoOpen); setLinhaOpen(false); setMarcaOpen(false); }}>
              Por Tipo ▾
            </span>
            {tipoOpen && (
              <div style={styles.dropMenu}>
...
const styles = {
  ...
  dropItem: { padding: '10px 16px', fontSize: 14, color: 'var(--texto)', transition: 'background 0.2s' },
